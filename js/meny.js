...
var Meny = {
	...
	create: function( options ) {
		return (function(){
            ...
            var domfixed = $(".meny")[1];
            domfixed.style.display = 'block';
            var menyContent= $(".meny-contents")[0];
            menyContent.className = menyContent.className + " menu-open";
					}
          ...
          Meny.dispatchEvent( dom.menu, 'open' );
            ...
            var domfixed = $(".meny")[1];
            domfixed.style.display = 'none';
            var menyContent= $(".meny-contents")[0];
            menyContent.className = "meny-contents";
					}
					// ...fall back on JS animation
					else {
						menuAnimation && menuAnimation.stop();
